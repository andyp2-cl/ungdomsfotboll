...
export const formatActivityForDatabase = (activity: Activity): any => {
  ...
  console.log(`Formatted activity for database: ${activity.id} (${activity.name}) with date ${activity.date}, type: ${activity.type}, cupId: ${formattedActivity.cup_id}, leagueId: ${formattedActivity.league_id}, matchReport: ${!!activity.matchReport}, youtubeLink: ${!!activity.youtubeLink}`);
